...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect('amqps://zowmmmin:ZPJIyrmN6JswWeABX-NisyUz7kERaRni@beaver.rmq.cloudamqp.com/zowmmmin', function (error0, connection) {
        if (error0) {
            throw error0;
        }
            ...
            app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            result = _a.sent();
                            return [4 /*yield*/, axios_1.default.post("http://localhost:8000/api/products", req.body)];
                        case 3:
                            _a.sent();
