...
createConnection().then(db => {
    ...
    amqp.connect('amqps://zowmmmin:ZPJIyrmN6JswWeABX-NisyUz7kERaRni@beaver.rmq.cloudamqp.com/zowmmmin', (error0, connection) => {
        if (error0) {
            throw error0
        }
        ...
        connection.createChannel((error1, channel) => {
            ...
            app.post('/api/products', async (req: Request, res: Response) => {
                ...
                await axios.post(`http://localhost:8000/api/products`, req.body)  
